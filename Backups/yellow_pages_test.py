...
def parse_listing(keyword,page):
	...
	url = "https://www.ebay.com.au/sch/i.html?_from=R40&_nkw={0}&_sacat=0&_pgn={1}".format(keyword,page)
	...
	for retry in range(10):
		try:
			...
			if response.status_code==200:
				...
				XPATH_LISTINGS = "//ul[@class='srp-results srp-list clearfix']" 
				listings = parser.xpath(XPATH_LISTINGS)
				scraped_results = []

				for results in listings:
					XPATH_BUSINESS_NAME = ".//he[@class='s-item__title']//text()" 
					XPATH_TELEPHONE = ".//span[@class='ITALIC']//text()" 
					XPATH_BUSSINESS_PAGE = ".//a[@class='s-item__link']//@href" 
